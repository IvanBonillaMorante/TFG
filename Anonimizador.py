            ...
            if(results[0].masks != None):
                ...
                for mascara in results[0].masks.masks:
                    ...
                    if mode != 0:
                        ...
                        io.imsave("/home/ivan/TFG/masks" + "/" +  img[0 : len(img) - 4] + "_" + str(i) + ".png", (mascara * 255).astype(np.uint8))
                        io.imsave("/home/ivan/TFG/images_fondo" + "/" + img[0 : len(img) - 4] + "_" + str(i) + ".png", (fondo * 255).astype(np.uint8))
                        io.imsave("/home/ivan/TFG/images_primer_plano" + "/" + img[0 : len(img) - 4] + "_" + str(i) + ".png", (primerPlano * 255).astype(np.uint8))
                        io.imsave("/home/ivan/TFG/images_resultado_stableDiffusion" + "/" + img[0 : len(img) - 4] + "_" + str(i) + ".png", (imagenProcesada * 255).astype(np.uint8))
